...
loader = DataLoader(raw_dataset, batch_size=50000, shuffle=False)
...
# TensorBoard writer
writer = SummaryWriter(log_dir='runs/lenet5_fashionmnist')
...
writer.add_image('FashionMNIST/Train_Images', img_grid, global_step=0)
